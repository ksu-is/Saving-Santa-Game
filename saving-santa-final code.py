...
if approach == "fight":
    ...
    if weapon == "1":
        ...
        print("You blast the elves with peppermint and they spin around laughing!")  
        time.sleep(a) 
        print("\nThe elves are friendly now and show you to the stables.")
        time.sleep(a) 
        pep_window =Tk()
        pep_window.title('Great choice!')
        pep_canvas = Canvas(pep_window, width=450, height=450)
        pep_canvas.pack()
        pep_image = PhotoImage(file='//Users//alaysiahhernton//Desktop//peppermint.png')
        pep_canvas.create_image(0, 0, anchor=NW, image=pep_image)
